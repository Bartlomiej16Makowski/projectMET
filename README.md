...
- https://github.com/Bartlomiej16Makowski/projectMET
- **DON'T** try to do it `Pixel Perfect` - implement it the most `simple` way so it looks similar;
- when you finish the first block of your page deploy it and create a Pull Request with a - [DEMO LINK](https://github.com/Bartlomiej16Makowski/projectMET)
